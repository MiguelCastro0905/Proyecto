...
def ver_qr(id_usuario: int):
    carpeta_destino = "C:\\Users\\Andres GV\\OneDrive\\Escritorio\\Proyecto\\Qr"
...
def ver_qr(id_usuario: int):
    carpeta_destino = "C:\\Users\\Andres GV\\OneDrive\\Escritorio\\Proyecto\\FotoUser"
...
def crear_carnet( id_usuario: int = Form(...), imagen: UploadFile = File(...)):
    try:
        ...
        ruta_guardado = f"C:\\Users\\Andres GV\\OneDrive\\Escritorio\\Proyecto\\FotoUser/{Foto}"
